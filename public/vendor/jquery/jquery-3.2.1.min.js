...
!(function (a, b) {
  ...
  function p(a, b) {
    b = b || d;
    const c = b.createElement('script');
  ...
  (r.fn = r.prototype =
    {
      ...
      pushStack(a) {
        const b = r.merge(this.constructor(), a);
      ...
      map(a) {
        return this.pushStack(r.map(this, (b, c) => a.call(b, c, b)));
      },
      slice() {
  ...
  const x = (function (a) {
    ...
    const I = function (a, b) {
      for (let c = 0, d = a.length; c < d; c++) if (a[c] === b) return c;
      return -1;
    };
    const J =
    ...
    const ea = ta((a) => a.disabled === !0 && ('form' in a || 'label' in a), {
      dir: 'parentNode',
      next: 'legend',
    });
    try {
    ...
    function ja(a) {
      let b = n.createElement('fieldset');
      try {
        return !!a(b);
      } catch (c) {
        return !1;
    ...
    (c = ga.support = {}),
      ...
      (ga.attr = function (a, b) {
        ...
        let f =
          e && C.call(d.attrHandle, b.toLowerCase()) ? e(a, b, !p) : void 0;
        return void 0 !== f
          ? f
          : c.attributes || !p
          ? a.getAttribute(b)
      ...
      (d = ga.selectors =
        {
          ...
          filter: {
            TAG(a) {
              const b = a.replace(_, aa).toLowerCase();
              return a === '*'
                ? function () {
                    return !0;
                  }
          ...
          pseudos: {
            ...
            first: pa(() => [0]),
            last: pa((a, b) => [b - 1]),
            eq: pa((a, b, c) => [c < 0 ? c + b : c]),
            even: pa((a, b) => {
              for (let c = 0; c < b; c += 2) a.push(c);
              return a;
            }),
            odd: pa((a, b) => {
              for (let c = 1; c < b; c += 2) a.push(c);
              return a;
            }),
            lt: pa((a, b, c) => {
    ...
    function va(a, b, c) {
      for (let d = 0, e = b.length; d < e; d++) ga(a, b[d], c);
      return c;
    }
    ...
    function za(a, b) {
      ...
      const f = function (f, g, h, i, k) {
        ...
        const y = (w += v == null ? 1 : Math.random() || 0.1);
        const z = x.length;
    ...
    return (
      ...
      m(),
      (c.sortDetached = ja(
        (a) => 1 & a.compareDocumentPosition(n.createElement('fieldset')),
      )),
      ja(
        (a) => (
        ...
        ka('type|href|height|width', (a, b, c) => {
      ...
      ja((a) => a.getAttribute('disabled') == null) ||
        ka(J, (a, b, c) => {
          let d;
          if (!c)
            return a[b] === !0
  ...
  function E(a, b, c) {
    return r.isFunction(b)
      ? r.grep(a, (a, d) => !!b.call(a, d, a) !== c)
      : b.nodeType
      ? r.grep(a, (a) => (a === b) !== c)
      : typeof b !== 'string'
      ? r.grep(a, (a) => i.call(b, a) > -1 !== c)
      : D.test(b)
      ? r.filter(b, a, c)
      : ((b = r.filter(b, a)),
        r.grep(a, (a) => i.call(b, a) > -1 !== c && a.nodeType === 1));
  }
  (r.filter = function (a, b, c) {
    ...
    r.fn.extend({
      ...
      is(a) {
        return !!E(
          this,
          typeof a === 'string' && A.test(a) ? r(a) : a || [],
          !1,
        ).length;
      },
    });
      ...
      var e = {
        ...
        pipe() {
          ...
          return r
            .Deferred((b) => {
              r.each(c, (c, d) => {
                const e = r.isFunction(a[d[4]]) && a[d[4]];
                f[d[1]](function () {
                  const a = e && e.apply(this, arguments);
  ...
  const T = function (a, b, c, d, e, f, g) {
    let h = 0;
    const i = a.length;
    let j = c == null;
    if (r.type(c) === 'object') {
    ...
    r.extend({
      ...
      _queueHooks(a, b) {
        ...
        return (
          W.get(a, c) ||
          W.access(a, c, {
            empty: r.Callbacks('once memory').add(() => {
  ...
  function fa(a, b, c, d) {
    ...
    let k = (r.cssNumber[b] || (j !== 'px' && +i)) && ba.exec(r.css(a, b));
    if (k && k[3] !== j) {
      (j = j || k[3]), (c = c || []), (k = +i || 1);
  ...
  const Na = function (b) {
    let c = b.ownerDocument.defaultView;
      ...
      c === 'margin' && (g += r.css(a, c + ca[f], !0, e)),
        d
          ? (c === 'content' && (g -= r.css(a, `padding${ca[f]}`, !0, e)),
            c !== 'margin' && (g -= r.css(a, `border${ca[f]}Width`, !0, e)))
          : ((g += r.css(a, `padding${ca[f]}`, !0, e)),
            c !== 'padding' && (g += r.css(a, `border${ca[f]}Width`, !0, e)));
    return g;
  }
  function $a(a, b, c) {
    let d;
    const e = Na(a);
    let f = Oa(a, b, e);
    const g = r.css(a, 'boxSizing', !1, e) === 'border-box';
    return Ma.test(f)
      ? f
  ...
  r.extend({
    ...
    r.each(['height', 'width'], (a, b) => {
      r.cssHooks[b] = {
        ...
        set(a, c, d) {
          ...
          const f = d && Na(a);
          const g =
            d && Za(a, b, d, r.css(a, 'boxSizing', !1, f) === 'border-box', f);
          return (
            g &&
              (e = ba.exec(c)) &&
              (e[3] || 'px') !== 'px' &&
    ...
    (r.cssHooks.marginLeft = Pa(o.reliableMarginLeft, (a, b) => {
      if (b)
        return `${
          parseFloat(Oa(a, 'marginLeft')) ||
          a.getBoundingClientRect().left -
            ea(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)
        }px`;
    })),
    r.each({ margin: '', padding: '', border: 'Width' }, (a, b) => {
      (r.cssHooks[a + b] = {
        expand(c) {
          for (
  ...
  (r.Tween = _a),
    (_a.prototype = {
      ...
      cur() {
        const a = _a.propHooks[this.prop];
  ...
  r.fn.extend({
    ...
    r.each(r.expr.match.bool.source.match(/\w+/g), (a, b) => {
      const c = mb[b] || r.find.attr;
      mb[b] = function (a, b, d) {
        let e;
        let f;
  ...
  r.fn.extend({
    ...
    r.extend({
      ...
      propHooks: {
        tabIndex: {
          get(a) {
            const b = r.find.attr(a, 'tabindex');
            return b
              ? parseInt(b, 10)
  ...
  r.fn.extend({
    ...
    hasClass(a) {
      ...
      b = ` ${a} `;
      while ((c = this[d++]))
        if (c.nodeType === 1 && ` ${pb(qb(c))} `.indexOf(b) > -1) return !0;
      return !1;
    },
  });
  const rb = /\r/g;
  ...
  const sb = /^(?:focusinfocus|focusoutblur)$/;
  r.extend(r.event, {
    trigger(b, c, e, f) {
      let g;
      let h;
    ...
    simulate(a, b, c) {
      const d = r.extend(new r.Event(), c, { type: a, isSimulated: !0 });
    ...
    o.focusin ||
      r.each({ focus: 'focusin', blur: 'focusout' }, (a, b) => {
        const c = function (a) {
  ...
  function Ab(a, b, c, d) {
    ...
    if (Array.isArray(b))
      r.each(b, (b, e) => {
        c || wb.test(a)
          ? d(a, e)
          : Ab(`${a}[${typeof e === 'object' && e != null ? b : ''}]`, e, c, d);
      });
    ...
    ajax(b, c) {
      ...
      var y = {
        ...
        setRequestHeader(a, b) {
          return (
            k == null &&
              ((a = w[a.toLowerCase()] = w[a.toLowerCase()] || a), (v[a] = b)),
            this
          );
        },
        overrideMimeType(a) {
  ...
  (o.cors = !!Sb && 'withCredentials' in Sb),
    ...
    r.ajaxPrefilter('script', (a) => {
      void 0 === a.cache && (a.cache = !1), a.crossDomain && (a.type = 'GET');
    }),
    r.ajaxTransport('script', (a) => {
      if (a.crossDomain) {
        let b;
        let c;
        return {
  ...
  r.ajaxSetup({
    jsonp: 'callback',
    jsonpCallback() {
      const a = Tb.pop() || `${r.expando}_${ub++}`;
      return (this[a] = !0), a;
    },
  }),
    r.ajaxPrefilter('json jsonp', (b, c, d) => {
      let e;
      let f;
      let g;
      const h =
    ...
    (o.createHTMLDocument = (function () {
      const a = d.implementation.createHTMLDocument('').body;
      return (
    ...
    (r.expr.pseudos.animated = function (a) {
      return r.grep(r.timers, (b) => a === b.elem).length;
    }),
    (r.offset = {
      setOffset(a, b, c) {
        let d;
    ...
    r.each({ scrollLeft: 'pageXOffset', scrollTop: 'pageYOffset' }, (a, b) => {
      const c = b === 'pageYOffset';
      r.fn[a] = function (d) {
        return T(
          this,
          (a, d, e) => {
    ...
    r.each(['top', 'left'], (a, b) => {
      r.cssHooks[b] = Pa(o.pixelPosition, (a, c) => {
        if (c)
          return (c = Oa(a, b)), Ma.test(c) ? `${r(a).position()[b]}px` : c;
      });
    }),
    r.each({ Height: 'height', Width: 'width' }, (a, b) => {
    ...
    (r.nodeName = B),
    typeof define === 'function' && define.amd && define('jquery', [], () => r);
  const Vb = a.jQuery;
  const Wb = a.$;
  return (
