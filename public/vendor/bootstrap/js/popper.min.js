 ...
 */ (function (e, t) {
  ...
  function u(e, o) {
    ...
    return (
      (i ? o.contains(d) : o === d && d.nodeName !== 'BODY') && (h = f(h, o)), h
    );
  }
  function b(e) {
    const t = window.document.documentElement;
  ...
  function w(e, t, i, r) {
    ...
    if (r === 'viewport') p = b(s);
      ...
      r === 'scrollParent'
        ? ((a = n(o(e))),
          a.nodeName === 'BODY' && (a = window.document.documentElement))
        : r === 'window'
  ...
  function E(e, t, o, i, n) {
    ...
    const f = a.length > 0 ? a[0].key : d[0].key;
    const l = e.split('-')[1];
    return f + (l ? `-${l}` : '');
  }
  function x(e, t, o) {
  ...
  function F(e, t, o) {
    ...
    const n =
      !!i && e.some((e) => e.name === o && e.enabled && e.order < i.order);
    if (!n) {
      const r = `\`${t}\``;
      console.warn(
        `\`${o}\`` +
  ...
  function G(e, t, o, i) {
    ...
    const s = p.indexOf(T(p, (e) => e.search(/,|\s/) !== -1));
    p[s] &&
      p[s].indexOf(',') === -1 &&
      console.warn(
  ...
  for (
    var z = Math.min,
      ...
      Q = function (e) {
        return X.some((t) => (e || '').toString().indexOf(t) > -1);
      },
    ...
    if (J && navigator.userAgent.indexOf(Z[ee]) >= 0) {
      $ = 1;
      break;
    }
  let i;
  ...
  var ie = function () {
    return (
      void 0 == i && (i = navigator.appVersion.indexOf('MSIE 10') !== -1), i
    );
  };
    ...
    function t(o, i) {
      ...
      ne(this, t),
        ...
        (this.modifiers = Object.keys(this.options.modifiers)
          .map((e) => ({ name: e, ...n.options.modifiers[e] }))
  ...
  return (
    (le.Utils = (typeof window === 'undefined' ? global : window).PopperUtils),
    (le.placements = de),
    (le.Defaults = {
      placement: 'bottom',
      eventsEnabled: !0,
      ...
      modifiers: {
          ...
          fn(e, t) {
            ...
            const s = {
              primary(e) {
                let o = p[e];
                return (
                  p[e] < i[e] && !t.escapeWithReference && (o = _(p[e], i[e])),
                  pe({}, e, o)
                );
              },
              secondary(e) {
        ...
        arrow: {
          ...
          fn(e, t) {
            ...
            const r = n.popper;
            const p = n.reference;
            const s = ['left', 'right'].indexOf(i) !== -1;
          ...
          fn(e, t) {
            ...
            return (
              p.forEach((s, d) => {
                ...
                const l = V;
                const m =
                  (i === 'left' && l(a.right) > l(f.left)) ||
                  (i === 'right' && l(a.left) < l(f.right)) ||
                  (i === 'top' && l(a.bottom) > l(f.top)) ||
                  (i === 'bottom' && l(a.top) < l(f.bottom));
                ...
                const b =
                  ...
                  (i === 'top' && g) ||
                  (i === 'bottom' && u);
                const y = ['top', 'bottom'].indexOf(i) !== -1;
                const w =
                  !!t.flipVariations &&
                  ((y && r === 'start' && h) ||
                    (y && r === 'end' && c) ||
        ...
        computeStyle: {
          ...
          fn(e, t) {
            ...
            const b = B('transform');
            if (
              ((d = c == 'bottom' ? -l.height + h.bottom : h.top),
              (s = u == 'right' ? -l.width + h.right : h.left),
              a && b)
            )
