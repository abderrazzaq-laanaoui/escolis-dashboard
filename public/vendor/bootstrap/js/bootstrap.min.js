  ...
  (function () {
    ...
    const r = (function (t) {
      ...
      function o() {
        ...
        for (const e in a) if (void 0 !== t.style[e]) return { end: a[e] };
        return !1;
      }
      function r(e) {
        const n = this;
      ...
      var l = {
        ...
        typeCheckConfig(t, i, o) {
          for (const r in o)
            if (o.hasOwnProperty(r)) {
              const s = o[r];
              const a = i[r];
              const l = a && n(a) ? 'element' : e(a);
              if (!new RegExp(s).test(l))
                throw new Error(
                  `${t.toUpperCase()}: Option "${r}" provided type "${l}" but expected type "${s}".`,
                );
            }
        },
      };
    ...
    const s =
      ((function (t) {
        const e = 'alert';
        const i = t.fn[e];
        const s = { DISMISS: '[data-dismiss="alert"]' };
        const a = {
          CLOSE: 'close.bs.alert',
          CLOSED: 'closed.bs.alert',
          CLICK_DATA_API: 'click.bs.alert.data-api',
        };
        const l = { ALERT: 'alert', FADE: 'fade', SHOW: 'show' };
        const h = (function () {
          function e(t) {
          ...
          return (
            ...
            (e.prototype._getRootElement = function (e) {
              const n = r.getSelectorFromElement(e);
              let i = !1;
              return (
                n && (i = t(n)[0]), i || (i = t(e).closest(`.${l.ALERT}`)[0]), i
              );
            }),
            ...
            (e.prototype._removeElement = function (e) {
              ...
              t(e).removeClass(l.SHOW),
                r.supportsTransitionEnd() && t(e).hasClass(l.FADE)
                  ? t(e)
                      .one(r.TRANSITION_END, (t) => n._destroyElement(e, t))
      ...
      (function (t) {
        const e = 'button';
        const i = t.fn[e];
        const r = { ACTIVE: 'active', BUTTON: 'btn', FOCUS: 'focus' };
        const s = {
        ...
        const l = (function () {
          ...
          return (
            (e.prototype.toggle = function () {
              let e = !0;
              let n = !0;
              const i = t(this._element).closest(s.DATA_TOGGLE)[0];
              if (i) {
                const o = t(this._element).find(s.INPUT)[0];
                if (o) {
                  if (o.type === 'radio')
                    if (o.checked && t(this._element).hasClass(r.ACTIVE))
                      e = !1;
                    else {
                      const a = t(i).find(s.ACTIVE)[0];
        ...
        t(document)
          .on(a.CLICK_DATA_API, s.DATA_TOGGLE_CARROT, (e) => {
            e.preventDefault();
            let n = e.target;
            t(n).hasClass(r.BUTTON) || (n = t(n).closest(s.BUTTON)),
              l._jQueryInterface.call(t(n), 'toggle');
          })
          .on(a.FOCUS_BLUR_DATA_API, s.DATA_TOGGLE_CARROT, (e) => {
            const n = t(e.target).closest(s.BUTTON)[0];
          ...
          return (
            ...
            (l.prototype._addEventListeners = function () {
              ...
              this._config.keyboard &&
                t(this._element).on(d.KEYDOWN, (t) => e._keydown(t)),
                this._config.pause === 'hover' &&
                  (t(this._element)
                    .on(d.MOUSEENTER, (t) => e.pause(t))
                    .on(d.MOUSELEAVE, (t) => e.cycle(t)),
                  'ontouchstart' in document.documentElement &&
                    t(this._element).on(d.TOUCHEND, () => {
                      e.pause(),
            ...
            (l.prototype._getItemByDirection = function (t, e) {
              ...
              if (((i && o === 0) || (n && o === r)) && !this._config.wrap)
                return e;
              const s = (o + (t === u.PREV ? -1 : 1)) % this._items.length;
              return s === -1
            ...
            (l.prototype._slide = function (e, n) {
              const i = this;
              const o = t(this._element).find(p.ACTIVE_ITEM)[0];
              const s = this._getItemIndex(o);
              const a = n || (o && this._getItemByDirection(e, o));
            ...
            (l._jQueryInterface = function (e) {
              return this.each(function () {
                let n = t(this).data(s);
                const o = t.extend({}, h, t(this).data());
                (void 0 === e ? 'undefined' : i(e)) === 'object' &&
                  t.extend(o, e);
                const r = typeof e === 'string' ? e : o.slide;
                if (
            ...
            (l._dataApiClickHandler = function (e) {
              const n = r.getSelectorFromElement(this);
              if (n) {
                const i = t(n)[0];
                if (i && t(i).hasClass(f.CAROUSEL)) {
                  const o = t.extend({}, t(i).data(), t(this).data());
      ...
      (function (t) {
        ...
        const s = 'bs.collapse';
        const a = t.fn[e];
        const l = { toggle: !0, parent: '' };
        const h = { toggle: 'boolean', parent: 'string' };
        const c = {
        ...
        const d = { WIDTH: 'width', HEIGHT: 'height' };
        const f = {
        ...
        const p = (function () {
          function a(e, i) {
            ...
            for (let o = t(f.DATA_TOGGLE), s = 0; s < o.length; s++) {
              const l = o[s];
              const h = r.getSelectorFromElement(l);
              h !== null &&
          ...
          return (
                ...
                if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                  ...
                  if (
                    ...
                    for (let o = 0; o < this._triggerArray.length; o++) {
                      ...
                      const a = r.getSelectorFromElement(s);
                      a !== null &&
                        (t(a).hasClass(u.SHOW) ||
            ...
            (a.prototype._getParent = function () {
              const e = this;
              const n = t(this._config.parent)[0];
            ...
            (a._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                const r = t.extend(
                  ...
                  l,
                  n.data(),
                  (void 0 === e ? 'undefined' : i(e)) === 'object' && e,
                );
                if (
        ...
        t(document).on(c.CLICK_DATA_API, f.DATA_TOGGLE, function (e) {
          ...
          const n = t(this);
          const i = r.getSelectorFromElement(this);
          t(i).each(function () {
            const e = t(this);
            const i = e.data(s) ? 'toggle' : n.data();
      ...
      (function (t) {
        ...
        const p = { placement: f.BOTTOM, offset: 0, flip: !0 };
        const _ = {
          placement: 'string',
          ...
          return (
            (l.prototype.toggle = function () {
              if (
                ...
                const n = t(this._menu).hasClass(u.SHOW);
                if ((l._clearMenus(), !n)) {
                  const i = { relatedTarget: this._element };
                  const o = t.Event(c.SHOW, i);
            ...
            (l.prototype._getPlacement = function () {
              const e = t(this._element).parent();
              let n = this._config.placement;
              return (
            ...
            (l._jQueryInterface = function (e) {
              return this.each(function () {
                let n = t(this).data(s);
                const o =
                  (void 0 === e ? 'undefined' : i(e)) === 'object' ? e : null;
                if (
                  (n || ((n = new l(this, o)), t(this).data(s, n)),
                  typeof e === 'string')
                ) {
            ...
            (l._clearMenus = function (e) {
              if (
                ...
                for (
                  let n = t.makeArray(t(d.DATA_TOGGLE)), i = 0;
                  i < n.length;
                  i++
                ) {
                  const o = l._getParentFromElement(n[i]);
                  const r = t(n[i]).data(s);
                  const a = { relatedTarget: n[i] };
                  if (r) {
                    const h = r._menu;
                    if (
                      t(o).hasClass(u.SHOW) &&
            ...
            (l._getParentFromElement = function (e) {
              let n = void 0;
              const i = r.getSelectorFromElement(e);
            ...
            (l._dataApiKeydownHandler = function (e) {
              if (
                !(
                  !h.test(e.which) ||
                  (/button/i.test(e.target.tagName) && e.which === 32) ||
                  /input|textarea/i.test(e.target.tagName) ||
                  (e.preventDefault(),
                  e.stopPropagation(),
                ...
                const n = l._getParentFromElement(this);
                const i = t(n).hasClass(u.SHOW);
                if (
                  (i || (e.which === 27 && e.which === 32)) &&
                  (!i || (e.which !== 27 && e.which !== 32))
                ) {
                  const o = t(n).find(d.VISIBLE_ITEMS).get();
                  if (o.length) {
                    let r = o.indexOf(e.target);
                    e.which === 38 && r > 0 && r--,
                      e.which === 40 && r < o.length - 1 && r++,
                      r < 0 && (r = 0),
                      o[r].focus();
                  }
                } else {
                  if (e.which === 27) {
                    const s = t(n).find(d.DATA_TOGGLE)[0];
                    t(s).trigger('focus');
                  }
        ...
        t(document)
          ...
          .on(c.CLICK_DATA_API, d.FORM_CHILD, (t) => {
            t.stopPropagation();
          }),
      ...
      (function (t) {
        ...
        const f = (function () {
          ...
          return (
              ...
              if (!this._isTransitioning) {
                ...
                t(this._element).trigger(i),
                  this._isShown ||
                    ...
                    t(this._element).on(c.CLICK_DISMISS, d.DATA_DISMISS, (t) =>
                      n.hide(t),
                    ),
              ...
              if (
                ...
                t(this._element).trigger(o),
                  this._isShown &&
                    ...
                    i
                      ? t(this._element)
                          .one(r.TRANSITION_END, (t) => n._hideModal(t))
            ...
            (a.prototype._showElement = function (e) {
              ...
              const o = t.Event(c.SHOWN, { relatedTarget: e });
              const s = function () {
            ...
            (a.prototype._showBackdrop = function (e) {
              const n = this;
              const i = t(this._element).hasClass(u.FADE) ? u.FADE : '';
              if (this._isShown && this._config.backdrop) {
                const o = r.supportsTransitionEnd() && i;
                if (
            ...
            (a.prototype._setScrollbar = function () {
              ...
              if (this._isBodyOverflowing) {
                t(d.FIXED_CONTENT).each((n, i) => {
                  const o = t(i)[0].style.paddingRight;
                  const r = t(i).css('padding-right');
                  t(i)
                  ...
                  t(d.NAVBAR_TOGGLER).each((n, i) => {
                    const o = t(i)[0].style.marginRight;
                    const r = t(i).css('margin-right');
                    t(i)
                      .data('margin-right', o)
                      .css(
                        'margin-right',
                ...
                const i = t('body').css('padding-right');
                t('body')
            ...
            (a.prototype._resetScrollbar = function () {
              t(d.FIXED_CONTENT).each((e, n) => {
                const i = t(n).data('padding-right');
                void 0 !== i &&
                  t(n).css('padding-right', i).removeData('padding-right');
              }),
                t(d.NAVBAR_TOGGLER).each((e, n) => {
        ...
        t(document).on(c.CLICK_DATA_API, d.DATA_TOGGLE, function (e) {
          const n = this;
          let i = void 0;
          const o = r.getSelectorFromElement(this);
          o && (i = t(o)[0]);
          const s = t(i).data('bs.modal')
            ? 'toggle'
            : t.extend({}, t(i).data(), t(this).data());
          (this.tagName !== 'A' && this.tagName !== 'AREA') ||
            e.preventDefault();
          var a = t(i).one(c.SHOW, (e) => {
      ...
      (function (t) {
        const e = 'scrollspy';
        const s = t.fn[e];
        const a = { offset: 10, method: 'auto', target: '' };
        const l = {
          offset: 'number',
          method: 'string',
        ...
        const d = { OFFSET: 'offset', POSITION: 'position' };
        const f = (function () {
          function s(e, i) {
            const o = this;
            n(this, s),
              ...
              t(this._scrollElement).on(h.SCROLL, (t) => o._process(t)),
              this.refresh(),
              this._process();
          }
          return (
            (s.prototype.refresh = function () {
              ...
              const o = i === d.POSITION ? this._getScrollTop() : 0;
              (this._offsets = []),
                (this._targets = []),
                ...
                t
                  ...
                  .map((e) => {
                    let n = void 0;
                    const s = r.getSelectorFromElement(e);
                    if ((s && (n = t(s)[0]), n)) {
            ...
            (s.prototype._getConfig = function (n) {
              if (typeof (n = t.extend({}, a, n)).target !== 'string') {
            ...
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                let n = t(this).data('bs.scrollspy');
                const o = (void 0 === e ? 'undefined' : i(e)) === 'object' && e;
                if (
                  (n || ((n = new s(this, o)), t(this).data('bs.scrollspy', n)),
                  typeof e === 'string')
                ) {
                  if (void 0 === n[e])
                    throw new Error(`No method named "${e}"`);
          ...
          return (
            (e.prototype.show = function () {
              ...
              if (
                ...
                let n = void 0;
                let o = void 0;
                const l = t(this._element).closest(a.NAV_LIST_GROUP)[0];
                const h = r.getSelectorFromElement(this._element);
                l &&
                  ((o = t.makeArray(t(l).find(a.ACTIVE))),
                  (o = o[o.length - 1]));
                const c = t.Event(i.HIDE, { relatedTarget: this._element });
                const u = t.Event(i.SHOW, { relatedTarget: o });
                if (
                  (o && t(o).trigger(c),
                  ...
                  const d = function () {
                    const n = t.Event(i.HIDDEN, { relatedTarget: e._element });
                    const r = t.Event(i.SHOWN, { relatedTarget: o });
            ...
            (e.prototype._activate = function (e, n, i) {
              const o = this;
              const l = t(n).find(a.ACTIVE)[0];
              const h =
                i && r.supportsTransitionEnd() && l && t(l).hasClass(s.FADE);
              const c = function () {
            ...
            (e.prototype._transitionComplete = function (e, n, i, o) {
              if (n) {
                ...
                const l = t(n.parentNode).find(a.DROPDOWN_ACTIVE_CHILD)[0];
              ...
              if (
                ...
                const h = t(e).closest(a.DROPDOWN)[0];
      ...
      (function (t) {
        ...
        const s = '.bs.tooltip';
        const a = t.fn[e];
        const l = new RegExp('(^|\\s)bs-tooltip\\S+', 'g');
        const h = {
          animation: 'boolean',
          template: 'string',
        ...
        const m = (function () {
          ...
          return (
            ...
            (a.prototype.show = function () {
              ...
              const n = t.Event(this.constructor.Event.SHOW);
              if (this.isWithContent() && this._isEnabled) {
                ...
                const s = r.getUID(this.constructor.NAME);
                o.setAttribute('id', s),
            ...
            (a.prototype.hide = function (e) {
              ...
              t(this.element).trigger(o),
                o.isDefaultPrevented() ||
                  ...
                  r.supportsTransitionEnd() && t(this.tip).hasClass(p.FADE)
                    ? t(i).one(r.TRANSITION_END, s).emulateTransitionEnd(150)
                    : s(),
                  (this._hoverState = ''));
            }),
            ...
            (a.prototype.setElementContent = function (e, n) {
              const o = this.config.html;
              (void 0 === n ? 'undefined' : i(n)) === 'object' &&
              (n.nodeType || n.jquery)
                ? o
              ...
              this.config.trigger.split(' ').forEach((n) => {
                if (n === 'click')
                  ...
                  t(e.element)
                    ...
                    .on(o, e.config.selector, (t) => e._leave(t));
                }
                t(e.element)
                  .closest('.modal')
            ...
            (a.prototype._fixTitle = function () {
              const t = i(this.element.getAttribute('data-original-title'));
            ...
            (a.prototype._enter = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                e &&
                  (n._activeTrigger[e.type === 'focusin' ? g.FOCUS : g.HOVER] =
                    !0),
            ...
            (a.prototype._leave = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                t(e.currentTarget).data(i, n)),
                e &&
                  (n._activeTrigger[e.type === 'focusout' ? g.FOCUS : g.HOVER] =
                    !1),
    ...
    !(function (r) {
      ...
      const d = r.extend({}, s.DefaultType, {
        content: '(string|element|function)',
      });
      const f = { FADE: 'fade', SHOW: 'show' };
      const p = { TITLE: '.popover-header', CONTENT: '.popover-body' };
      const _ = {
        HIDE: `hide${l}`,
        HIDDEN: `hidden${l}`,
        SHOW: `show${l}`,
      ...
      const g = (function (s) {
        ...
        return (
          ...
          (h._jQueryInterface = function (t) {
            return this.each(function () {
              let e = r(this).data('bs.popover');
              const n =
                (void 0 === t ? 'undefined' : i(t)) === 'object' ? t : null;
              if (
